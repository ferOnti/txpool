...
/*
    ...
    public void testNodeInfo() {
        ...
        TxpoolNodeInfo txpoolNodeInfo = deserialiseResponse(TxpoolNodeInfo.class);
        assertThat(txpoolNodeInfo.getNodeInfo(), equalTo(
                new TxpoolNodeInfo.NodeInfo("0xca843569e3427144cead5e4d5999a3d0ccf92b8e",
                        "0x0fbdc686b912d7722dc86510934589e0aaf3b55a",
                        true,
                        false,
                        new TxpoolNodeInfo.BlockMakeStrategy(5, 2, "active", "deadline"))));
    }
